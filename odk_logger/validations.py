"""
formhub/odk_logger/validations.py --> Defines user-written validation routines for various ODK X-forms.
   (works kind of like urls.py)

This file must define an object named "validation_patterns",
 which must contain either: an empty sequence,
 or the value returned from a call to submission_time_validation.val_patterns(),
   which takes as arguments a sequence of 2-tuples,
    each of which was returned from the function submission_time_validation.val(),
