...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('odk_logger_instance', 'status', self.gf('django.db.models.fields.CharField')(default=u'submitted_via_web', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Instance.status'
        db.delete_column('odk_logger_instance', 'status')
