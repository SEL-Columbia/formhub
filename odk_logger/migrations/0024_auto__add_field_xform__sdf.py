...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'XForm._sdf'
        db.add_column('odk_logger_xform', '_sdf',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'XForm._sdf'
        db.delete_column('odk_logger_xform', '_sdf')
    ...
    models = {
        ...
        'odk_logger.xform': {
            ...
            '_sdf': ('django.db.models.fields.TextField', [], {'null': 'True'}),
