...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LGA.survey_round'
        db.add_column('nga_districts_lga', 'survey_round', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LGA.survey_round'
        db.delete_column('nga_districts_lga', 'survey_round')
