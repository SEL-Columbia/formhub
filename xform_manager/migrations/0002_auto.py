...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field groups on 'XForm'
        db.create_table('xform_manager_xform_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('xform', models.ForeignKey(orm['xform_manager.xform'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('xform_manager_xform_groups', ['xform_id', 'group_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field groups on 'XForm'
        db.delete_table('xform_manager_xform_groups')
