...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('submission_qr_qualityreview', 'submission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['xform_manager.Instance']))


    def backwards(self, orm):
        
        # Changing field 'QualityReview.submission'
        db.alter_column('submission_qr_qualityreview', 'submission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsed_xforms.ParsedInstance']))
    ...
    models = {
        ...
        'submission_qr.qualityreview': {
            ...
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quality_reviews'", 'to': "orm['xform_manager.Instance']"})
        },
