...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phone.surveyor'
        db.add_column('odk_dropbox_phone', 'surveyor', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['odk_dropbox.Surveyor']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phone.surveyor'
        db.delete_column('odk_dropbox_phone', 'surveyor_id')
    ...
    models = {
        ...
        'odk_dropbox.phone': {
            ...
            'surveyor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['odk_dropbox.Surveyor']"}),
