...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Phone.surveyor'
        db.alter_column('odk_dropbox_phone', 'surveyor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['odk_dropbox.Surveyor'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Phone.surveyor'
        raise RuntimeError("Cannot reverse this migration. 'Phone.surveyor' and its values cannot be restored.")
