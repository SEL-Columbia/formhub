...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('parsed_xforms_datadictionary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('xform', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data_dictionary', to=orm['xform_manager.XForm'])),
            ('json', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('parsed_xforms', ['DataDictionary'])


    def backwards(self, orm):
        
        # Deleting model 'DataDictionary'
        db.delete_table('parsed_xforms_datadictionary')
