...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParsedInstance.is_new'
        db.add_column('parsed_xforms_parsedinstance', 'is_new', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParsedInstance.is_new'
        db.delete_column('parsed_xforms_parsedinstance', 'is_new')
