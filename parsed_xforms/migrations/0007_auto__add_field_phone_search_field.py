...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phone.search_field'
        db.add_column('odk_dropbox_phone', 'search_field', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phone.search_field'
        db.delete_column('odk_dropbox_phone', 'search_field')
