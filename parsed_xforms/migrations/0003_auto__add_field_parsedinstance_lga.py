...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ParsedInstance.lga'
        db.add_column('parsed_xforms_parsedinstance', 'lga', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nga_districts.LGA'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ParsedInstance.lga'
        db.delete_column('parsed_xforms_parsedinstance', 'lga_id')
