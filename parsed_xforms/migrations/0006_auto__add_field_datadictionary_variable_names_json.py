...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataDictionary.variable_names_json'
        db.add_column('parsed_xforms_datadictionary', 'variable_names_json', self.gf('django.db.models.fields.TextField')(default=u'{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataDictionary.variable_names_json'
        db.delete_column('parsed_xforms_datadictionary', 'variable_names_json')
