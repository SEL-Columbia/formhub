...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('parsed_xforms_parsedinstance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.OneToOneField')(related_name='parsed_instance', unique=True, to=orm['xform_manager.Instance'])),
            ('phone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['phone_manager.Phone'])),
            ('surveyor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveyor_manager.Surveyor'], null=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.District'], null=True)),
        ))
        db.send_create_signal('parsed_xforms', ['ParsedInstance'])


    def backwards(self, orm):
        
        # Deleting model 'ParsedInstance'
        db.delete_table('parsed_xforms_parsedinstance')
