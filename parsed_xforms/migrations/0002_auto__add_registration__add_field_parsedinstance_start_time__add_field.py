...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('parsed_xforms_registration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parsed_instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsed_xforms.ParsedInstance'])),
            ('surveyor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surveyor_manager.Surveyor'])),
        ))
        db.send_create_signal('parsed_xforms', ['Registration'])

        # Adding field 'ParsedInstance.start_time'
        db.add_column('parsed_xforms_parsedinstance', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'ParsedInstance.end_time'
        db.add_column('parsed_xforms_parsedinstance', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('parsed_xforms_registration')

        # Deleting field 'ParsedInstance.start_time'
        db.delete_column('parsed_xforms_parsedinstance', 'start_time')

        # Deleting field 'ParsedInstance.end_time'
        db.delete_column('parsed_xforms_parsedinstance', 'end_time')
