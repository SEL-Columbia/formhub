...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Phone', fields ['visible_id']
        db.delete_unique('phone_manager_phone', ['visible_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Phone', fields ['visible_id']
        db.create_unique('phone_manager_phone', ['visible_id'])
