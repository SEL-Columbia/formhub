...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Phone'
        db.create_table('phone_manager_phone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('imei', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('status', self.gf('django.db.models.fields.CharField')(default='functional', max_length=16)),
            ('note', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('visible_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ...
            ('search_field', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('phone_manager', ['Phone'])


    def backwards(self, orm):
        
        # Deleting model 'Phone'
        db.delete_table('phone_manager_phone')
