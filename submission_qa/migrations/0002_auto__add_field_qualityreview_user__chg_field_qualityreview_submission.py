...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'QualityReview', fields ['submission']
        db.delete_unique('submission_qa_qualityreview', ['submission_id'])

        # Adding field 'QualityReview.user'
        db.add_column('submission_qa_qualityreview', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quality_reviews', null=True, to=orm['auth.User']), keep_default=False)

        # Changing field 'QualityReview.submission'
        db.alter_column('submission_qa_qualityreview', 'submission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parsed_xforms.ParsedInstance']))


    def backwards(self, orm):
        
        # Deleting field 'QualityReview.user'
        db.delete_column('submission_qa_qualityreview', 'user_id')

        # Changing field 'QualityReview.submission'
        db.alter_column('submission_qa_qualityreview', 'submission_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['parsed_xforms.ParsedInstance']))

        # Adding unique constraint on 'QualityReview', fields ['submission']
        db.create_unique('submission_qa_qualityreview', ['submission_id'])
