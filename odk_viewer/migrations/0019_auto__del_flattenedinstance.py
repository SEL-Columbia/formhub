...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'odk_viewer_flattenedinstance', (
            ('mongo_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flattened_instance', to=orm['odk_logger.Instance'])),
