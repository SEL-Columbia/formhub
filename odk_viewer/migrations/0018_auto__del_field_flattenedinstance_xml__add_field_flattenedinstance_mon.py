...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FlattenedInstance.xml'
        db.delete_column(u'odk_viewer_flattenedinstance', 'xml')

        # Adding field 'FlattenedInstance.mongo_id'
        db.add_column(u'odk_viewer_flattenedinstance', 'mongo_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'FlattenedInstance.xml'
        db.add_column(u'odk_viewer_flattenedinstance', 'xml',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'FlattenedInstance.mongo_id'
        db.delete_column(u'odk_viewer_flattenedinstance', 'mongo_id')
    ...
    models = {
        ...
        'odk_viewer.flattenedinstance': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flattened_instance'", 'to': "orm['odk_logger.Instance']"}),
            'mongo_id': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
